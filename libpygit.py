...
argparser = argparse.ArgumentParser(description="Version control for people with trust issues")
...
def repo_find(path=".", required=True):
    ...
    if parent == path:
        ...
        if required:
            raise Exception("No pygit directory.")
        else:
            return None
